...
function generateSubMenu(){
	global $db;
				...
				while ($row = mysqli_fetch_object($ergebnis)) {
					...
					if ($zaehler!=3){ //3 ist der market und wird später generiert
						echo '<div class="selectBox" id="subMenu' . $zaehler . '" style="left:40%; right: 21%;">';
					...
					<div class="menuButton" id="subMenu$zaehler-$zaehler2" data-goRight="subMenu$zaehler-$goRight" data-goLeft="subMenu$zaehler-$goLeft"  data-actionValue="$name2"	>				
SUBMENU;
  					echo '<img src="pics/' . $path2 . '0.png">';
					echo '<div class="numberBadge" id="numberBadge'.$name2.'">0</div></div>';
						...
						//DATA <itemName>Output  - The output f.E. "2*wheat"
...
function generateMarket(){
	...
	echo '<div id="subMenu3" class="marketContainer">';
	
	$befehl = "SELECT * FROM farmer WHERE type='subMenu1';";
					$ergebnis2 = mysqli_query($db, $befehl);
					$zaehler = 0;
					while ($row = mysqli_fetch_object($ergebnis2)) {
						$name = $row -> name;
					...
					<div class="marketSubContainer" id="subMenu3-$zaehler" data-goRight="subMenu3-$goRight" data-goLeft="subMenu3-$goLeft" >					
SUBMENU;
  					echo '<img src="pics/' . $path . '0.png">';
					echo '<div class="numberBadge" id="numberBadge'.$name.'">0</div></div>';
					}
